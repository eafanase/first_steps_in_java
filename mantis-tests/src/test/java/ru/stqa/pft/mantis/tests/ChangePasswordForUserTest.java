...
public class ChangePasswordForUserTest extends TestBase {
  @BeforeMethod
  ...
  @Test
  public void testPasswordChangeForUser() throws IOException, MessagingException {
    ...
    app.ui().uiLogin(app.getProperty("web.adminLogin"), app.getProperty("web.adminPassword"));
